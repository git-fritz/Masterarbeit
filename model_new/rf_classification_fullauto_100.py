# -*- coding: utf-8 -*-
"""
Random Forest Classification with Threshold Tuning (Youden's J vs G-Mean)
...
output_root = r"E:\Thesis\data\MODEL\rf_class_new_results\auto"
...
json.dump({"optimal_threshold": float(final_threshold), "method": best_method},
          open(os.path.join(out_dir, f"{full_id}_optimal_threshold.json"), "w"))
...
plt.hist(results_df["thresholded_misclassified"], bins=[-0.5, 0.5, 1.5],
         rwidth=0.7, color="orange", edgecolor="black")
...
# 🧠 Check shape and use proper class index for classification
